...
<html>
<head>
    <title><?= getenv('TITLE_SITE') ?> | Datos de Persona</title>
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    <p>
                        ...
                        <p class="text-muted"><?= $Datapersona->getNumeroDocumento().": ".$Datapersona->getTipoDocumento() ?></p>
                        <hr>
                        <strong><i class="fas fa-map-marker-alt mr-1"></i>Ciudad</strong>
                        <p class="text-muted"><?= $Datapersona->getCiudad() ?></p>
                        <hr>
                    <strong><i class="fas fa-map-marker-alt mr-1"></i>Genero</strong>
                    <p class="text-muted"><?= $Datapersona->getGenero() ?></p>
                    <hr>
                    ...
                    <hr>
                    <strong><i class="fas fa-map-marker-alt mr-1"></i>Fecha_nacimiento</strong>
                    <p class="text-muted"><?= $Datapersona->getFechaNacimiento() ?></p>
                    </p>
