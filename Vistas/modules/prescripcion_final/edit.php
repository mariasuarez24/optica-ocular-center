                        ...
                        <form class="form-horizontal" method="post" id="frmEditprescripcionfinal" name="frmEditprescripcionfinal" action="../../../App/Controlador/Prescripcionfinalcontrolador.php?action=edit">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="Diagnostico_OI" class="col-sm-2 col-form-label">Diagnostico_OI</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="Diagnostico_OD" class="col-sm-2 col-form-label">Diagnostico_OD</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="AV_OD" class="col-sm-2 col-form-label">AV_OD</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="VL_OD" class="col-sm-2 col-form-label">VL_OD</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="AV_OI" class="col-sm-2 col-form-label">AV_OI</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="VL_OI" class="col-sm-2 col-form-label">VL_OI</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="VP_OD" class="col-sm-2 col-form-label">VP_OD</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="VP_OI" class="col-sm-2 col-form-label">VP_OI</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="DNP_OD" class="col-sm-2 col-form-label">DNP_OD</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="DNP_OI" class="col-sm-2 col-form-label">DNP_OI</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="AB_OD" class="col-sm-2 col-form-label">AB_OD</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="AB_OI" class="col-sm-2 col-form-label">AB_OI</label>
                                    <div class="col-sm-10">
