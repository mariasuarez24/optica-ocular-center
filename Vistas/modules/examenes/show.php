...
<html>
<head>
    <title><?= getenv('TITLE_SITE') ?> | Datos del Examen</title>
        ...
        <section class="content">
            ...
            <?php if(!empty($_GET['respuesta'])){ ?>
                <?php if ($_GET['respuesta'] == "error"){ ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        Error al consultar el examen: <?= ($_GET['mensaje']) ?? "" ?>
                    </div>
                <?php } ?>
            ...
            <div class="card card-info">
                ...
                <div class="card-header">
                    <h3 class="card-title"><?= $DataExamen->getNombre()  ?></h3>
                </div>
                <div class="card-body">
                    <p>
                        <strong><i class="fas fa-book mr-1"></i> Nombre</strong>
                    <p class="text-muted">
                        <?= $DataExamen->getNombre() ?>
                    </p>
                    <hr>
                    <strong><i class="fas fa-user mr-1"></i> Descripción</strong>
                    <p class="text-muted"><?= $DataExamen->getDescripcion() ?></p>
                    </p>
                </div>
                        ...
                        <div class="row">
                            <div class="col-auto mr-auto">
                                <a role="button" href="index.php" class="btn btn-success float-right" style="margin-right: 5px;">
                                    <i class="fas fa-tasks"></i> Gestionar Examen
                                </a>
                            </div>
                            <div class="col-auto">
