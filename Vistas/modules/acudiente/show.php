...
<html>
<head>
    <title><?= getenv('TITLE_SITE') ?> | Datos de Acudiente</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Informacion de Acudiente</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <div class="card card-info">
                <?php if(!empty($_GET["id"]) && isset($_GET["id"])){
                    $Dataacudiente = acudientecontrolador::searchForID($_GET["id"]);
                    if(!empty($Dataacudiente)){
                ?>
                <div class="card-header">
                    <h3 class="card-title"><?= $Dataacudiente->getParentezco()  ?></h3>
                </div>
                <div class="card-body">
                    <p>
                        ...
                        <p class="text-muted"><?= $Dataacudiente->getParentezco() ?></p>
                        </p>
                    ...
                    <div class="row">
                        <div class="col-auto mr-auto">
                            <a role="button" href="index.php" class="btn btn-success float-right" style="margin-right: 5px;">
                                <i class="fas fa-tasks"></i> Gestionar Acudiente
                            </a>
                        </div>
                        <div class="col-auto">
