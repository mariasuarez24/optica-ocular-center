...
require('../Modelos/ExamenesHistorial.php');
...
class ExamenesHistorialControlador
{
    static function main($action)
    {
        if ($action == "create") {
            ...
            ExamenesHistorialControlador::editar();
        } else if ($action == "buscarID") {
             ExamenesHistorialControlador::buscarID($_REQUEST['idExamenhistorial']);
        } else if ($action == "ActivarExamenesHistorial") {
          ExamenesHistorialControlador::ActivarExamenesHistorial();
        } else if ($action == "InactivarExamenesHistorial") {
              ExamenesHistorialControlador::InactivarExamenesHistorial();
        }else if ($action == "Valores_Paremetros_idValoresParametros"){
    ...
    static public function create()
    {
        try {
            ...
            $arrayexameneshistorial = new ExamenesHistorial ($arrayexameneshistorial);
            $arrayexameneshistorial->create();
            header("Location: ../../Vistas/modules/Examenes_Historial/index.php?respuesta=correcto&action=create");
        } catch (Exception $e) {
