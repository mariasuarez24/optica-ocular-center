...
require('../Modelos/FormulaMedica.php');
...
class FormulaMedicaControlador
{
    static function main($action)
    {
        if ($action == "create") {
            ...
            FormulaMedicaControlador::editar();
        } else if ($action == "buscarID") {
             FormulaMedicaControlador::buscarID($_REQUEST['idMotivoConsulta']);
        } else if ($action == "ActivarMotivoConsulta") {
          FormulaMedicaControlador::ActivarMotivoConsulta();
        } else if ($action == "InactivarMotivoConsulta") {
              FormulaMedicaControlador::InactivarMotivoConsulta();
    ...
    static public function create()
    {
        try {
            ...
            $arrayformulamedica['Fecha'] = $_POST['Descripcion'];
            $arrayformulamedica['Descripcion'] = $_POST['Descripcion'];
            $arrayformulamedica['Prescripcion_id_Prescripcion_final'] = $_POST['Prescripcion_id_Prescripcion_final'];
            $formula_medica = new FormulaMedica ($arrayformulamedica);
            $formula_medica->create();
            header("Location: ../../Vistas/modules/formula_medica/index.php?respuesta=correcto&action=create");
        } catch (Exception $e) {
