...
if(!empty($_GET['action'])){
    acudientecontrolador::main($_GET['action']);
}else{
    echo "No se encontro ninguna accion...";
}

class acudientecontrolador{
    ...
    static public function create()
    {
        try {
            ...
            if(!acudiente::acudienteregistrada($arrayacudiente['parentezco'])){
                $acudiente = new acudiente ($arrayacudiente);
                $acudiente->store();
                header("Location: ../../Vistas/modules/acudiente/index.php?respuesta=correcto&action=create");
            }else{
                header("Location: ../../Vistas/modules/acudiente/create.php?respuesta=error&mensaje=persona ya registrada");
            }
        } catch (Exception $e) {
